...
let arr = [1, 2, 3, 4, 5]; // Initialize an array named arr with the values 1, 2, 3, 4, and 5
console.log(arr); // Print the contents of the arr array to the console
arr.push(6);
console.log(arr);
arr.pop();
console.log(arr);
...
let num_1 = 1;
while (num_1 <= 10) {
  // Initialize num_1 to 1, and continue the loop as long as num_1 is less than or equal to 10
  console.log(num_1); // condition is true, it will print the current value of num_1 to the console
  num_1 = num_1 + 1; // updating the value of num_1 by incrementing it by 1 in each iteration
}
